...
const WORLD_NOTIFY_URL = 'https://developer.worldcoin.org/api/v2/minikit/send-notification';

type NotificationType = 'dissolution_requested' | 'proposal_received' | 'proposal_accepted';
...
const NOTIFICATIONS: Record<NotificationType, { title: string; message: string; path: string }> = {
    ...
    proposal_received: {
        title: '🤝 Bond Proposal',
        message: '${username}, you received a bond proposal. Tap to review.',
        path: '/marriage/proposals',
    },
    proposal_accepted: {
        title: '✅ Bond Accepted',
        message: '${username}, your proposal was accepted. The bond is now active.',
        path: '/home',
    },
};
